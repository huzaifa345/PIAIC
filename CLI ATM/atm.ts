...
const red = (msg: string) => chalk.redBright(msg);
const white = (msg : string | {}) => chalk.whiteBright(msg)
const green = (msg : string) => chalk.greenBright(msg)
const blue = (msg : string) => chalk.blueBright(msg)
const ul = (msg : string | {}) => chalk.underline(msg)
...
let exitConfirmer = (operationFunction: Function) => {
    inquirer.prompt([{
        name: 'confirmation',
        type: 'confirm',
        ...
        .then((res) => {
            if (res.confirmation) operationFunction()
            else {
